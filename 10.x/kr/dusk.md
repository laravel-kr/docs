...
`DatabaseTruncation` 트레이트를 사용하기 전에 Composer 패키지 매니저를 사용하여 `doctrine/dbal` 패키지를 설치해야 합니다:
...
`dusk` 명령은 PHPUnit 테스트 러너에서 일반적으로 허용되는 모든 인수를 받습니다. 예를 들어 특정 [그룹](https://docs.phpunit.de/en/10.5/annotations.html#group)에 대한 테스트만 실행할 수 있습니다:
