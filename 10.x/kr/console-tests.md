...
`expectsQuestion`, `expectsOutput`, `doesntExpectOutput`, `expectsOutputToContain`, `doesntExpectOutputToContain`, `assertExitCode` 메서드를 활용하여 다음 테스트로 이 명령어를 테스트할 수 있습니다.
