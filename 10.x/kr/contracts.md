...
각 Contract에는 프레임워크에서 제공하는 해당 구현체가 있습니다. 예를 들어, Laravel은 다양한 드라이버를 지원하는 큐 구현체와 [Symfony Mailer](https://symfony.com/doc/6.0/mailer.html)로 구동되는 메일러 구현체를 제공합니다.
