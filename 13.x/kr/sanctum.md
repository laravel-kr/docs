...
시작하려면, 사용자의 이메일 / 사용자명, 비밀번호 및 기기 이름을 받아 해당 자격 증명을 새 Sanctum 토큰으로 교환하는 라우트를 만드세요. 이 엔드포인트에 제공되는 "기기 이름"은 정보 제공 목적이며 원하는 값이면 됩니다. 일반적으로 기기 이름 값은 "Nuno의 iPhone 17"와 같이 사용자가 인식할 수 있는 이름이어야 합니다.
