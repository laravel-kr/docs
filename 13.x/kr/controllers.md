...
- [컨트롤러 미들웨어](#controller-middleware)
    - [미들웨어 어트리뷰트](#middleware-attributes)
    - [인가 어트리뷰트](#authorization-attributes)
...
PHP 어트리뷰트를 사용하여 컨트롤러에 미들웨어를 할당할 수도 있습니다:
...
개별 컨트롤러 메서드에도 미들웨어 어트리뷰트를 배치할 수 있습니다. 메서드에 할당된 미들웨어는 클래스 수준에서 할당된 미들웨어와 병합됩니다:
...
정책을 통해 컨트롤러 액션을 인가하는 경우, `Authorize` 어트리뷰트를 `can` 미들웨어의 편리한 단축키로 사용할 수 있습니다:
...
첫 번째 인수는 인가하려는 권한(ability)입니다. 두 번째 인수는 정책에 전달해야 할 모델 클래스, 라우트 파라미터, 또는 파라미터 배열입니다.
